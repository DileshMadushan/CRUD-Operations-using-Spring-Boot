...
import com.bmt.MyStore.models.Client; // Correct import
...
public class ClientsController {
    ...
    public String createClient(
        ...
        Client client = new Client(); // Corrected instantiation
    ...
    public String showEditPage(Model model, @RequestParam int id) {
        ...
        model.addAttribute("client", client);  // Add the Client object
        model.addAttribute("clientDto", clientDto);  // Add the ClientDto object
